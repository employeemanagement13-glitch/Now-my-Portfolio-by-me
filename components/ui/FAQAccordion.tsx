        ...
        return (
          ...
          >
            ...
            <button
              ...
              className={`flex items-center justify-between w-full text-left px-5 py-4 max-sm:py-5 cursor-pointer rounded-full max-sm:rounded-2xl transition-all duration-300 ${
